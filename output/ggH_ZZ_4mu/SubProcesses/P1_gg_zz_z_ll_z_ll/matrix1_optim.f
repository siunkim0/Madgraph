...
C     
C     Process: g g > h > z z HIG<=1 HIW<=1 WEIGHTED<=4 @1
C     *   Decay: z > mu+ mu- HIG<=1 HIW<=1 WEIGHTED<=2
C     *   Decay: z > mu+ mu- HIG<=1 HIW<=1 WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_4_3(W(1,5),W(1,8),GC_40,GC_54,MDL_MZ,FK_MDL_WZ,W(1,9))  !  count 4
      CALL FFV2_4_3(W(1,6),W(1,7),GC_40,GC_54,MDL_MZ,FK_MDL_WZ,W(1,10))  !  count 4
      ...
      CALL FFV2_4_3(W(1,11),W(1,14),GC_40,GC_54,MDL_MZ,FK_MDL_WZ,W(1,15)
     $)  !  count 4
      CALL FFV2_4_3(W(1,12),W(1,13),GC_40,GC_54,MDL_MZ,FK_MDL_WZ,W(1,16)
     $)  !  count 4
      CALL VVS3_3(W(1,1),W(1,3),GC_13,MDL_MH,FK_MDL_WH,W(1,17))  !  count 4
      CALL VVS3_3(W(1,2),W(1,4),GC_13,MDL_MH,FK_MDL_WH,W(1,18))  !  count 4
      CALL VVS2P1N_1(W(1,15), W(1,17), GC_73, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_1(W(1,15), W(1,18), GC_73, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_1(W(1,16), W(1,17), GC_73, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_1(W(1,16), W(1,18), GC_73, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/9,10/),
