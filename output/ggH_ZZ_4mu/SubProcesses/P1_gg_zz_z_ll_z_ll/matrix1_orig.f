...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_4_3(W(1,3),W(1,4),GC_40,GC_54,MDL_MZ, FK_MDL_WZ,W(1,5))
      CALL IXXXXX(P(0,5),ZERO,NHEL(5),-1*IC(5),W(1,4))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,3))
      CALL FFV2_4_3(W(1,4),W(1,3),GC_40,GC_54,MDL_MZ, FK_MDL_WZ,W(1,6))
      CALL VVS3_3(W(1,1),W(1,2),GC_13,MDL_MH, FK_MDL_WH,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS2_0(W(1,5),W(1,6),W(1,3),GC_73,AMP(1))
